        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            <div className="lg:col-span-7 bg-[#EFECE4] p-8 sm:p-10 rounded-3xl border border-[#1C1917]/10 shadow-sm space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-xs text-[#1C1917]/70 font-light">
                  Fill in your project details and preferred date for a private design discussion.
                </p>
              </div>

              {formSubmitted ? (
                <div className="p-8 bg-[#656D4A] text-[#F5F2EB] rounded-2xl space-y-3 text-center">
                ...
                >
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea
                      rows={4}
                      placeholder="Tell us about your room dimensions, preferred wood tones, or budget..."
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="bg-[#EFECE4] p-6 rounded-3xl border border-[#1C1917]/10 space-y-4">
                ...
                <div className="space-y-3 text-xs text-[#1C1917]/80">
                  <div className="p-3 bg-white rounded-xl border border-[#1C1917]/10">
                    <span className="font-semibold block text-[#1C1917]">
                      Can I view furniture in 3D before ordering?
                    </span>
                    <span className="font-light text-[#1C1917]/70 mt-1 block">
                      Yes! Every collection item on GRAINS includes an interactive 3D WebGL viewer.
                    </span>
                  </div>
                  ...
                  <div className="p-3 bg-white rounded-xl border border-[#1C1917]/10">
                    ...
                    <span className="font-light text-[#1C1917]/70 mt-1 block">
                      We offer white-glove international shipping with on-site assembly.
                    </span>
                  </div>
                </div>
              </div>
